        ...
        <div className="bg-white pt-20 pb-16 sm:pt-28 sm:pb-24">
          <div className="container max-w-4xl mx-auto px-4">
            ...
            <div className="prose prose-slate max-w-none text-slate-600 text-base leading-relaxed space-y-6">
              ...
              {/* Section 1 */}
              <h2 className="text-2xl font-bold text-slate-900 pt-6 border-b pb-2">1. Interpretation</h2>
              <p>Within these terms and conditions, the following definitions apply:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>“Customer” or “You”</strong> refers to any individual who purchases services from Bond Clean Specialist.</li>
                <li><strong>“We” or “Us”</strong> refers to Bond Clean Specialist or any authorized contractor approved by Bond Clean Specialist.</li>
              ...
              {/* Section 2 */}
              <h2 className="text-2xl font-bold text-slate-900 pt-6 border-b pb-2">2. Inappropriate Behavior</h2>
              <p>
              ...
              {/* Section 3 */}
              <h2 className="text-2xl font-bold text-slate-900 pt-6 border-b pb-2">3. Pricing</h2>
              <ul className="list-disc pl-6 space-y-2">
              ...
              {/* Section 4 */}
              <h2 className="text-2xl font-bold text-slate-900 pt-6 border-b pb-2">4. Access</h2>
              <ul className="list-disc pl-6 space-y-2">
              ...
              {/* Section 5 */}
              <h2 className="text-2xl font-bold text-slate-900 pt-6 border-b pb-2">5. Postponement, Cancellations and Refund Policy</h2>
              <ul className="list-disc pl-6 space-y-2">
              ...
              {/* Section 6 */}
              <h2 className="text-2xl font-bold text-slate-900 pt-6 border-b pb-2">6. Payment</h2>
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>In the case of work orders from rental/leasing agencies or government agencies, we need a formal work order approving the cost and details of the same party responsible for the payment. Bond Clean Specialist will never chase the customers or any third party.</li>
              </ul>

              {/* Section 7 */}
              <h2 className="text-2xl font-bold text-slate-900 pt-6 border-b pb-2">7. Bond Return Guarantee</h2>
              <ul className="list-disc pl-6 space-y-2">
              ...
              {/* Section 8 */}
              <h2 className="text-2xl font-bold text-slate-900 pt-6 border-b pb-2">8. Claims &amp; Complaints</h2>
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>To file a complaint, please send a written message to <a href="mailto:support@bondclean.au" className="text-primary hover:underline">support@bondclean.au</a>.</li>
